...
suite("luacheck Tests", () => {
    ...
    test("bad_whitespace.lua", () => {
        ...
        let reports = checker.check(CHECK_DATA);
        let req: luacheck.report[] = [{ "code": "612", "column": 26, "end_column": 26, "line": 4, "message": "line contains trailing whitespace" }, { "code": "612", "column": 25, "end_column": 25, "line": 8, "message": "line contains trailing whitespace" }, { "code": "612", "column": 40, "end_column": 40, "line": 13, "message": "line contains trailing whitespace" }, { "code": "611", "column": 1, "end_column": 1, "line": 17, "message": "line contains only whitespace" }, { "code": "611", "column": 1, "end_column": 1, "line": 18, "message": "line contains only whitespace" }, { "code": "611", "column": 1, "end_column": 2, "line": 19, "message": "line contains only whitespace" }, { "code": "611", "column": 1, "end_column": 3, "line": 20, "message": "line contains only whitespace" }, { "code": "621", "column": 1, "end_column": 2, "line": 25, "message": "inconsistent indentation (SPACE followed by TAB)" }]
        assert(JSON.stringify(req) == JSON.stringify(reports))
    });
    test("compat.lua", () => {
        const CHECK_DATA = path.join(TEST_DATA_ROOT, 'samples', 'compat.lua');
        let reports = checker.check(CHECK_DATA);
        let req: luacheck.report[] = [{ "code": "113", "column": 2, "end_column": 8, "line": 1, "name": "setfenv", "message": "accessing undefined variable 'setfenv'" }, { "code": "113", "column": 22, "end_column": 28, "line": 1, "name": "setfenv", "message": "accessing undefined variable 'setfenv'" }]
    ...
    test("empty.lua", () => {
        ...
        let req: luacheck.report[] = []
        assert(JSON.stringify(req) == JSON.stringify(reports))
    });
    test("global_inline_options.lua", () => {
        const CHECK_DATA = path.join(TEST_DATA_ROOT, 'samples', 'global_inline_options.lua');
        let reports = checker.check(CHECK_DATA);
        let req: luacheck.report[] = [{ "code": "131", "column": 10, "end_column": 10, "line": 6, "name": "f", "message": "unused global variable 'f'" }, { "code": "111", "column": 4, "end_column": 6, "line": 7, "name": "baz", "message": "setting non-standard global variable 'baz'" }, { "code": "111", "column": 4, "end_column": 11, "line": 18, "name": "external", "message": "setting non-module global variable 'external'", "module": true }]
        assert(JSON.stringify(req) == JSON.stringify(reports))
    });
    test("globals.lua", () => {
        ...
        let req: luacheck.report[] = [{ "code": "113", "column": 7, "end_column": 13, "line": 1, "name": "setfenv", "message": "accessing undefined variable 'setfenv'" }]
        assert(JSON.stringify(req) == JSON.stringify(reports))
    });
    test("good_code.lua", () => {
    ...
    test("indirect_globals.lua", () => {
        ...
        let req: luacheck.report[] = [{ "code": "113", "column": 11, "end_column": 16, "line": 2, "name": "global", "message": "accessing undefined variable 'global'" }, { "code": "122", "column": 1, "end_column": 8, "line": 5, "name": "table", "message": "indirectly mutating read-only global variable 'table'", "indirect": true }, { "code": "113", "column": 32, "end_column": 37, "line": 5, "name": "global", "message": "accessing undefined variable 'global'" }]
        assert(JSON.stringify(req) == JSON.stringify(reports))
    });
    ...
    test("python_code.lua", () => {
        ...
        let req: luacheck.report[] = [{ "code": "011", "column": 6, "end_column": 15, "line": 1, "msg": "expected '=' near '__future__'", "message": "expected '=' near '__future__'" }]
        assert(JSON.stringify(req) == JSON.stringify(reports))
    });
    ...
    test("unused_secondaries.lua", () => {
        ...
        let req: luacheck.report[] = [{ "code": "211", "column": 7, "end_column": 7, "line": 3, "name": "a", "message": "unused variable 'a'" }, { "code": "211", "column": 7, "end_column": 7, "line": 6, "name": "x", "message": "unused variable 'x'" }, { "code": "211", "column": 13, "end_column": 13, "line": 6, "name": "z", "message": "unused variable 'z'" }, { "code": "311", "column": 1, "end_column": 1, "line": 12, "name": "o", "message": "value assigned to variable 'o' is unused" }]
        assert(JSON.stringify(req) == JSON.stringify(reports))
    });
});